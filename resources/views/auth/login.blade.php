        ...
        <div class="max-w-md w-full bg-white shadow-xl rounded-lg overflow-hidden">
            <div class="p-8 sm:p-10">
                <div class="text-center mb-8">
                    <i class="fas fa-user-circle text-5xl text-emerald-600 mb-4"></i>
                    <h2 class="text-3xl font-bold text-gray-900">Welcome Back</h2>
                    <p class="mt-2 text-gray-600">Sign in to your Fiora account</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center">
                            <input type="checkbox" name="remember" class="h-4 w-4 text-emerald-600 border-gray-300 rounded">
